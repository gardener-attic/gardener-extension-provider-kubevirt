...
import (
	...
	"github.com/gardener/gardener-extension-provider-kubevirt/pkg/validator"
...
var log = logf.Log.WithName("gardener-extensions-validator-kubevirt")
...
func NewValidatorCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use: fmt.Sprintf("validator-%s", providerkubevirt.Type),
