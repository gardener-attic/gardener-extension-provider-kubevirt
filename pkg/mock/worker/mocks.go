...
func (m *MockActuator) Delete(arg0 context.Context, arg1 *v1alpha1.Worker, arg2 *extensions.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockActuator) Migrate(arg0 context.Context, arg1 *v1alpha1.Worker, arg2 *extensions.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockActuator) Reconcile(arg0 context.Context, arg1 *v1alpha1.Worker, arg2 *extensions.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockActuator) Restore(arg0 context.Context, arg1 *v1alpha1.Worker, arg2 *extensions.Cluster) error {
	m.ctrl.T.Helper()
