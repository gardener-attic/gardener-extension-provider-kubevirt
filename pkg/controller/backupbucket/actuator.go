...
func newActuator(logger logr.Logger) backupbucket.Actuator {
	return &actuator{
		logger: logger,
	}
}
...
func (a *actuator) Reconcile(ctx context.Context, bb *extensionsv1alpha1.BackupBucket) error {
	...
	return s3Client.CreateBucketIfNotExists(ctx, bb.Name, bb.Spec.Region)
}
...
func (a *actuator) Delete(ctx context.Context, bb *extensionsv1alpha1.BackupBucket) error {
	...
	return s3Client.DeleteBucketIfExists(ctx, bb.Name)
}
